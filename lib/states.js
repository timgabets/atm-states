    ...
    switch(parsed.get('type')){
      case 'A':
        ...
        case 'B':
          ...
          this.addStateLinks(parsed, ['timeout_next_state', 'cancel_next_state', 'local_pin_check_good_next_state', 'local_pin_check_max_bad_pins_next_state', 'remote_pin_check_next_state']);
          break;
        ...
        case 'b':
          ...
          this.addStateLinks(parsed, ['timeout_next_state', 'cancel_next_state', 'good_read_next_state', 'csp_fail_next_state']);
          break;
        ...
        case 'C':
          ...
          this.addStateLinks(parsed, ['next_state',]);
          break;
        ...
        case 'E':
          ...
          this.addStateLinks(parsed, ['timeout_next_state', 'cancel_next_state', 'FDK_A_next_state', 'FDK_B_next_state', 'FDK_C_next_state', 'FDK_D_next_state']);
          break;
        ...
        case 'G':
          ...
          this.addStateLinks(parsed, ['amount_check_condition_true', 'amount_check_condition_false']);
          break;
        ...
        case 'I':
          ...
          this.addStateLinks(parsed, ['timeout_next_state',]);
          break;
        ...
        case 'k':
          ...
          this.addStateLinks(parsed, ['good_read_next_state',]);
          break;
        ...
        case 'm':
          ...
          this.addStateLinks(parsed, ['timeout_next_state', 'cancel_next_state',]);
          break;
        ...
        case 'U':
          ...
          this.addStateLinks(parsed, ['device_available_next_state', 'device_unavailable_next_state',]);
          break;
        ...
        case 'X':
          ...
          this.addStateLinks(parsed, ['timeout_next_state', 'cancel_next_state', 'FDK_next_state']);
          break;
        ...
        case '?':
          ...
          this.addStateLinks(parsed, ['next_state', 'amount_too_large_next_state']);
          break;
        ...
        case '+':
          ...
          this.addStateLinks(parsed, ['icc_init_started_next_state', 'icc_init_not_started_next_state']);
          break;
